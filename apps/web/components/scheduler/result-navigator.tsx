...
export function ResultNavigator() {
  ...
  return (
    <div className="flex items-center justify-between gap-4 px-1">
      ...
      <button className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium border border-border text-muted hover:border-border-strong hover:text-text transition-colors duration-150">
